...
import org.person.sa.common.module.support.operatelog.OperateLogDao;
...
public abstract class OperateLogAspect {
    ...
    private static final String pointCut = "@within(org.person.sa.common.module.support.operatelog.annoation.OperateLog)";
