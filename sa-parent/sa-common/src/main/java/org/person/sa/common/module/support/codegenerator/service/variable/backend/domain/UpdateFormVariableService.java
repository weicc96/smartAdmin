...
import org.person.sa.common.module.support.codegenerator.domain.model.CodeInsertAndUpdate;
    ...
    public ImmutablePair<List<String>, List<Map<String, Object>>> getPackageListAndFields(List<CodeInsertAndUpdateField> fields, CodeGeneratorConfigForm form) {
        ...
        for (CodeInsertAndUpdateField field : fields) {
            ...
            if (SmartStringUtil.isNotEmpty(codeField.getEnumName())) {
                packageList.add("import org.person.sa.common.common.swagger.ApiModelPropertyEnum;");
                packageList.add("import org.person.sa.common.common.validator.enumeration.CheckEnum;");
            ...
            if (SmartStringUtil.isNotEmpty(codeField.getDict())) {
                ...
                packageList.add("import org.person.sa.common.common.json.deserializer.DictValueVoDeserializer;");
            }
            ...
            if (SmartStringUtil.contains(field.getFrontComponent(), "Upload")) {
                ...
                packageList.add("import com.fasterxml.jackson.databind.annotation.JsonDeserialize;");
                packageList.add("import org.person.sa.common.common.json.deserializer.FileKeyVoDeserializer;");
            }
