...
public class JweAspect {
    ...
    @Before("@annotation(org.person.sa.common.module.support.jwe.JweDecrypt)")
    ...
    @AfterReturning(returning = "object", pointcut = "@annotation(org.person.sa.common.module.support.jwe.JweEncrypt)")
